const AccordionOrangeTitle = {
    /* html */
    template: `
        <!-- Accordion, Orange Gradient Title -->
        <section class="accordion-block accordion-block--light accordion-block--subheading-gradient-orange">
            <div class="container">
                <!-- copy container -->
        ...
        <!-- Speaker Modal, Light -->
        <div id="speaker-modal-4" class="modal fade speaker-modal speaker-modal--light" tabindex="-1">
